 ...
 const edited = (e) => {
  ...
  return (
    ...
    <form >
            <label >Name :</label>
            <br />
            <input type="text" onChange={edichange} name="name" className='input' ></input>
            <br />
            <label>Age :</label>
            <br />
            <input type="number" onChange={edichange} name="age" className='input'></input>
            <br />
            <label>Course :</label>
            <br />
            <input type="text" onChange={edichange} name="course" className='input'></input>
            <br />
            <label>Batch :</label>
            <br />
            <input type="text" onChange={edichange} name="batch" className='input'></input>
            <br />
